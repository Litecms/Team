...
$(document).ready(function(){
    ...
    $(".team-team .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/team.team.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".team-team .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.team-team .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'team.team.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#team-team-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#team-team-list .btn-reset-filter').css('display', 'none');
